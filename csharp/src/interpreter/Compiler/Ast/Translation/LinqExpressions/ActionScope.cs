...
namespace DynamicScript.Compiler.Ast.Translation.LinqExpressions
{
    ...
    sealed class ActionScope : RoutineScope, IActionLexicalScope
    {
        ...
        private ActionScope(LexicalScope parent, ScriptCodeActionImplementationExpression expression)
            : base(parent)
        {
        ...
        public static ActionScope Create(LexicalScope parent, ScriptCodeActionImplementationExpression expression)
        {
            return new ActionScope(parent, expression);
        }
        ...
        /// <returns></returns>
        public bool DeclareParameter(string parameterName, out ParameterExpression declaration)
        {
            return DeclareParameter<IRuntimeSlot>(parameterName, out declaration);
        }
