...
namespace DynamicScript.Runtime.Environment
{
    ...
    /// </summary>
    [ComVisible(false)]
    public abstract class ScriptGetItemFunction: ScriptFunctionBase, IIndexerAccessor
    {
        #region Nested Types
        ...
        private ScriptGetItemFunction(ActionContract contract, IScriptObject @this = null)
            : base(contract, @this)
        {
        }
        ...
        /// <param name="this">The item getter owner.</param>
        public ScriptGetItemFunction(IScriptContract valueContract, IScriptContract[] indicies, IScriptObject @this = null)
        ...
        /// <param name="valueContract">The contract of the value to set.</param>
        /// <param name="indicies">The contracts of the indicies.</param>
        public static ScriptFunctionContract GetContractBinding(IScriptContract valueContract, params IScriptContract[] indicies)
        {
    ...
    [ComVisible(false)]
    internal abstract class ScriptGetItemFunction<TOwner> : ScriptGetItemFunction
        where TOwner : class, IScriptObject
    {
        ...
        /// <param name="indicies">The indicies of the item getter.</param>
        /// <param name="this">The item getter owner.</param>
        public ScriptGetItemFunction(IScriptContract valueContract, IScriptContract[] indicies, TOwner @this)
