...
namespace DynamicScript.Runtime.Environment
{
    ...
    /// </summary>
    [ComVisible(false)]
    public sealed class ScriptIteratorFunction: ScriptFunc
    {
        #region Nested Types

        [ComVisible(false)]
        private sealed class IteratorActionContract : ScriptFunctionContract
        {
        ...
        public ScriptIteratorFunction(IEnumerable collection, IScriptContract elementContract, IScriptObject @this = null)
        ...
        /// <param name="elementContract"></param>
        /// <returns></returns>
        public static ScriptFunctionContract GetContractBinding(IScriptContract elementContract)
        {
