...
var queue = $asyncscript.container.create(
...
var evaluate = $asyncscript.newLambda(function(code){
	var result = new $asyncscript.Promise();
	$asyncscript.run(code, null, result.complete.bind(result));
	return result;
}, String);

module.exports.asyncscript = $asyncscript.container.create(
	{name: "queue", value: queue},
	{name: "eval", value: evaluate},
	{name: "gc", value: $asyncscript.newLambda(function() { })}
);
