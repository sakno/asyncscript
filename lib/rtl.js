...
var runtimeErrors = $asyncscript.errors = {
	...
	undeclaredId: function(name, filename, position){
		...
		return position ? this.create('ASRUNTIME_UNDECLARED_NAME', filename + 'Identifier ' + name + ' was not declared') : this.create('Identifier ' + name + ' was not declared');
	}
};
...
function Property(getter, setter, contract, _this){
	...
	Object.defineProperty(this, "shouldCache", {writable: false, value: cached});
